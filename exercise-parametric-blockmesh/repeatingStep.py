import numpy as np
from heatedChannel.OpenFoamDataWriter import OpenFoamDataWriter
import os
...
class GenerateRepeatingStep(object):
    ...
    def _create_one_level_blocks(self, i):
        ...
        data = ["hex (%i %i %i %i %i %i %i %i) (%i %i %i) " % (i*n+0, i*n+1, i*n+7, i*n+6, i*n+10, i*n+11, i*n+17, i*n+16, self.mesh_den*self.L1, self.mesh_den*self.H, self.mesh_den*self.s) + " simpleGrading ((1)((0.2 0.3 4)(0.6 0.4 1)(0.2 0.3 0.25))(1))",
                "hex (%i %i %i %i %i %i %i %i) (%i %i %i) " % (i*n+1, i*n+4, i*n+8, i*n+7, i*n+11, i*n+14, i*n+18, i*n+17, self.mesh_den*(self.L2-self.L1), self.mesh_den*self.H, self.mesh_den*self.s) + " simpleGrading ((1)((0.2 0.3 4)(0.6 0.4 1)(0.2 0.3 0.25))(1))",
                "hex (%i %i %i %i %i %i %i %i) (%i %i %i) " % (i*n+2, i*n+3, i*n+5, i*n+4, i*n+12, i*n+13, i*n+15, i*n+14, self.mesh_den*(self.L3-self.L2), self.mesh_den*self.h, self.mesh_den*self.s) + " simpleGrading (1 1 1)",
                "hex (%i %i %i %i %i %i %i %i) (%i %i %i) " % (i*n+4, i*n+5, i*n+9, i*n+8, i*n+14, i*n+15, i*n+19, i*n+18, self.mesh_den*(self.L3-self.L2), self.mesh_den*(self.H), self.mesh_den*self.s) + " simpleGrading ((1)((0.2 0.3 4)(0.6 0.4 1)(0.2 0.3 0.25))(1))",
                ]
        return data
