...
@author: becker_martin@t-online.de
'''
import os
import os.path
...
class OpenFoamDataWriter(object):
    ...
    def _create_header(self):
        ...
        self._foamfile_lines.append(r"|  \\    /   O peration     | Version:  1.6                                   |")
        self._foamfile_lines.append(r"|   \\  /    A nd           | Web:      www.OpenFOAM.org                      |")
    ...
    def _create_foamfile_part(self):
        ...
        self._foamfile_lines.append("    location    \"" + self._location + "\";")
